...
class TrainingPipeline():
    ...
    def prepare_dataset(self):
        ...
        self.dataframe = self.dataframe[self.dataframe['Date'] > '2000-01-01']
    ...
    def evaluate_models(self, y_true, y_pred):
        ...
        return pd.DataFrame({'MAE': [mae], 'RSME': [rmse], 'R2': [r2]})
    ...
    def run(self):
        ...
        result.to_csv('data/4-predictions/model_evaluation.csv', index=False)
        self.save_model()
